...
<p align="center">
  Социальное пространство для тех, с кем хочется быть на связи.<br />
...
<!-- После подготовки замените следующий блок на:
![Главная Voople](./docs/readme-assets/01-home.webp)
-->

> 📷 **Место для главного скриншота**<br />
> Главная с компактной навигацией, блоком «Сейчас», лентой и живым правым rail.<br />
> Подпись в shots.so: **«Те, с кем хочется быть на связи»**
...
<!-- После подготовки замените следующий блок на:
![Чат и комната Voople](./docs/readme-assets/02-chat-room.webp)
-->

> 📷 **Место для скриншота чата и комнаты**<br />
> Групповой чат с разделами и активной комнатой либо аккуратный split-screen.<br />
> Подпись в shots.so: **«Один разговор — от сообщения до комнаты»**

<!-- После подготовки замените следующий блок на:
![Демонстрация экрана в Voople](./docs/readme-assets/03-screen-share.webp)
-->

> 📷 **Место для скриншота демонстрации**<br />
> Демонстрация приложения с двумя участниками и полностью видимым кадром.<br />
> Подпись в shots.so: **«Показывайте, объясняйте, смотрите вместе»**
...
<!-- После подготовки замените следующий блок на:
![Профиль и кастомизация Voople](./docs/readme-assets/04-profile.webp)
-->

> 📷 **Место для скриншота профиля**<br />
> Двухколоночный профиль с заметной, но не перегруженной кастомизацией.<br />
> Подпись в shots.so: **«Профиль, который действительно ваш»**
