...
pub(crate) fn process_tree(root: u32) -> std::collections::HashSet<u32> {
...
pub fn list_process_audio_sources(
    excluded_root_process_id: u32,
) -> Result<Vec<ProcessAudioSource>, String> {
    ...
    unsafe {
        ...
        let excluded_processes = process_tree(excluded_root_process_id);
