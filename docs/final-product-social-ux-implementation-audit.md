...
| 5 | Полноценный блок «Сейчас» | Частично | Active room/online/listening, лимит 5, компактный empty, pins до 3 и точные rule-based веса реализованы; migrations 53–55 применены и зарегистрированы. Gaming presence, invite action и полный candidate pool общих групп ещё не закрыты. |
