...
| 45 | Shared icon controls and tooltips | Запланировано | Инвентаризация Room/chat/header/composer/media actions; общий web/desktop tooltip primitive, icon-only только для однозначных действий, обязательные aria-label/focus/touch/screen-reader gates |
