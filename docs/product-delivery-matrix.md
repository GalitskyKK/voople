...
между Room той же Group; следующий P3-срез объединит его локальные draft, reply,
upload, read и optimistic state с основной Conversation composition.
