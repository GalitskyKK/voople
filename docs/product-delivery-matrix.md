...
сохраняется при minimize/unmount. Следующий P3-срез объединит reply, upload,
edit/reaction и desktop transport state с основной Conversation composition.
