...
| 58 | Message confidentiality programme | Планирование · P0 trust | Threat model и audit текущего transport/storage/auth/logging; затем audited E2EE protocol с device keys, verification/rotation/recovery, attachments, groups, reports и compatibility — без собственной криптографии и преждевременных claims |
| 59 | Public repository protection | В работе · P0 engineering | Ruleset/protected master, required checks/review, no force-push/delete, least-privilege Actions, dependency/secret/code scanning и документированный release bypass |
