...
поправки из `rework_plan/VOOPLE_CORE_REWORK_ADDENDUM.md` зафиксированы ниже:
...
конфликте эти поправки имеют приоритет. Старые discovery/экономические задачи
не должны вытеснять ядро.
