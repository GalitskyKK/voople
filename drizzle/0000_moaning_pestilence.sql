CREATE TYPE "public"."acquired_via" AS ENUM('purchase', 'earned', 'gifted', 'seasonal_reward');--> statement-breakpoint
CREATE TYPE "public"."avatar_type" AS ENUM('constructor', 'photo');--> statement-breakpoint
CREATE TYPE "public"."banner_type" AS ENUM('color', 'pattern', 'animated');--> statement-breakpoint
CREATE TYPE "public"."chat_type" AS ENUM('direct', 'group');--> statement-breakpoint
CREATE TYPE "public"."item_type" AS ENUM('effect', 'ring', 'banner', 'nameplate', 'badge', 'reaction_pack');--> statement-breakpoint
CREATE TYPE "public"."notif_type" AS ENUM('like', 'card_reaction', 'follow', 'reply', 'repost', 'match', 'mystery_drop');--> statement-breakpoint
CREATE TYPE "public"."post_media_type" AS ENUM('image', 'gif', 'meme');--> statement-breakpoint
CREATE TYPE "public"."subscription_tier" AS ENUM('plus', 'pro');--> statement-breakpoint
CREATE TYPE "public"."track_source" AS ENUM('upload', 'chat', 'post');--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "card_reactions" ADD CONSTRAINT "card_reactions_profile_user_id_users_id_fk" FOREIGN KEY ("profile_user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "card_reactions" ADD CONSTRAINT "card_reactions_reactor_user_id_users_id_fk" FOREIGN KEY ("reactor_user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "messages" ADD CONSTRAINT "messages_shared_post_id_posts_id_fk" FOREIGN KEY ("shared_post_id") REFERENCES "public"."posts"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "messages" ADD CONSTRAINT "messages_shared_track_id_playlist_tracks_id_fk" FOREIGN KEY ("shared_track_id") REFERENCES "public"."playlist_tracks"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "profile_customization" ADD CONSTRAINT "profile_customization_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_anthem" ADD CONSTRAINT "user_anthem_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_anthem" ADD CONSTRAINT "user_anthem_track_id_playlist_tracks_id_fk" FOREIGN KEY ("track_id") REFERENCES "public"."playlist_tracks"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "playlist_user_idx" ON "playlist_tracks" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "posts_author_idx" ON "posts" USING btree ("author_id");--> statement-breakpoint
CREATE INDEX "posts_created_at_idx" ON "posts" USING btree ("created_at");--> statement-breakpoint
CREATE INDEX "status_history_user_idx" ON "status_history" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "status_history_time_idx" ON "status_history" USING btree ("captured_at");--> statement-breakpoint
CREATE INDEX "inventory_user_idx" ON "user_inventory" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "inventory_unique" ON "user_inventory" USING btree ("user_id","item_id");--> statement-breakpoint
