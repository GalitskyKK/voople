...
export default function LegalServicesPage() {
  ...
  return (
    <LegalDocument title="Услуги и цены">
      ...
      <p>
        Подписка даёт доступ к расширенному оформлению профиля и приложения, дополнительным фонам диалогов,
        истории из двенадцати недавних аватаров, пину Voople+ и одному активному бусту группы. Буст открывает
        собственный цветовой акцент выбранной группы и может быть перенесён в другую группу. Срок действия
        зависит от выбранного тарифа и начинается с момента успешной оплаты. Повторная оплата добавляет
        выбранный срок к текущей дате окончания, если подписка ещё активна.
      </p>
