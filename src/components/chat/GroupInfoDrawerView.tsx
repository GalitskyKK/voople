...
export function GroupInfoDrawerView({
  ...
  return (
    <>
      ...
      <IconButton label="Информация о группе" tooltipSide="bottom" onClick={() => show("info")} className="inline-flex h-9 w-9 items-center justify-center rounded-xl text-[var(--app-muted)] transition hover:bg-[var(--app-surface-soft)] hover:text-[var(--foreground)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--theme-accent)]">
