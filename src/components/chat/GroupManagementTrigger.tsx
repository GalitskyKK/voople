  ...
  return (
    <>
      <GroupAvatar
        ...
        className="voople-group-identity__avatar"
      />
      <span className="voople-group-identity__copy min-w-0 flex-1">
        <span className="flex min-w-0 items-center gap-1.5">
          <span className="voople-group-identity__name block min-w-0 truncate font-semibold">{chatName}</span>
        ...
        <span className="voople-group-identity__meta block truncate text-xs font-normal text-[var(--app-muted)]">{memberCount} участников</span>
      </span>
    </>
  );
}
  ...
  return (
    <button
      ...
      className={identityVariant
        ? "voople-group-header-identity flex min-w-0 flex-1 items-center gap-3 rounded-[var(--app-radius-sm)] text-left transition hover:bg-[var(--app-surface-soft)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--theme-accent)]"
