...
export function ScreenShareStatusBanner({ hasAudio }: { hasAudio: boolean }) {
  return (
    <div className="mb-3 flex shrink-0 items-center gap-2 rounded-xl border border-[var(--app-border)] bg-[var(--app-surface-soft)] px-3 py-2 text-xs text-[var(--app-muted)]" role="status">
