...
test("group perks match the product contract", () => {
  assert.deepEqual(
    ...
    [
      { level: 0, emoji: 10, sounds: 0, fileMb: 15, banner: false, animatedIcon: false, animatedBanner: false, tag: false, vanity: false, roleStyles: false },
      { level: 1, emoji: 20, sounds: 0, fileMb: 15, banner: false, animatedIcon: false, animatedBanner: false, tag: false, vanity: false, roleStyles: false },
      { level: 3, emoji: 50, sounds: 8, fileMb: 15, banner: false, animatedIcon: true, animatedBanner: false, tag: false, vanity: false, roleStyles: false },
      { level: 6, emoji: 100, sounds: 16, fileMb: 50, banner: true, animatedIcon: true, animatedBanner: false, tag: false, vanity: false, roleStyles: false },
